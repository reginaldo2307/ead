...
@section('content')
    @if(count($banners) > 0 && in_array('banner_section'.config('layout_sections'), compact(null)))
    ...
    @endif
    @if(in_array('statistics_section'.config('layout_sections'), compact(null)))
    ...
    @if(in_array('popular_courses_section'.config('layout_sections'), compact(null)))
    ...
    @if(in_array('trending_categories_section'.config('layout_sections'), compact(null)))
    ...
    @if(in_array('top_rated_courses_section'.config('layout_sections'), compact(null)))
    ...
    @if(count($bundles) > 0 && in_array('bundle_courses_section'.config('layout_sections'), compact(null)))
    ...
    @if(isset($widgets['video_promotion_section_widget']) && in_array('video_promotion_section_widget'.config('layout_sections'), compact(null)))
    ...
    @endif
    @if(in_array('partner_companies_section'.config('layout_sections'), compact(null)) && count($sponsors) > 0)
    ...
    @endif
    @if(in_array('learning_points_section'.config('layout_sections'), compact(null)))
    ...
    @if(in_array('promotional_section_three_widget'.config('layout_sections'), compact(null)))
